...
public class DirectoriesProvider
{
    ...
    // [api]
    public static Dictionary<string, string?> GetSpecialFolders()
    {
    ...
    private static string? GetDefaultLinuxPath(string xdgKey)
    {
    ...
    // [api]
    public static List<DriverInfo> GetDrives()
    {
        // 获取所有驱动器
    ...
    private static string? GetSpecialFolderPath(string xdgKey, Environment.SpecialFolder? specialFolder)
    {
        if (IsLinux())
        {
            // Linux下优先读取XDG配置
